...
function Sphere() {
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      // Subtle Spidey-red kiss only on the highest-displaced "web pulses".
      // Keeps the wireframe brutalist; the red is a whisper, not a glow.
      vec3 webRed = vec3(0.78, 0.12, 0.18);
      float redMix = smoothstep(0.05, 0.13, abs(vDisplacement));
      vec3 color = mix(baseWhite, webRed * (0.6 + intensity), redMix * 0.32);
